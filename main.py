...
api_key = "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"
...
async def generate_interview_question(
    ...
    try:
        ...
        # file_path = os.path.join("temp_files", pdf_file.filename)
        # with open(file_path, "wb") as buffer:
        #     buffer.write(pdf_file.file.read())
        
        # Load PDF and get data
        tmp_location = os.path.join('/tmp',"/Users/kaushalagarwal/Downloads/Chandradeep_Fullstack-1.pdf")
        loader = PDFMinerLoader(r"/Users/kaushalagarwal/Downloads/Chandradeep_Fullstack-1.pdf")
        loader1 = PyPDFium2Loader("/Users/kaushalagarwal/Downloads/Chandradeep_Fullstack-1.pdf")
        
        data = pages[0]
        data1 = str(loader1.load())
        print(data)
        print(data1)
